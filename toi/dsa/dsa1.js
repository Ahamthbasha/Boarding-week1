...
// console.log(linearSearch([1,2,3,4,10,9],10))
...
// function binarySearch(arr,k){
//     return binarySearchRecursive(arr,k,0,arr.length-1)
// }

// function binarySearchRecursive(arr,k,leftIndex,rightIndex){
...
//     }
//     else if(k < arr[mid]){
//         return binarySearchRecursive(arr,k,leftIndex,mid-1)
//     }
//     else{
//         return binarySearchRecursive(arr,k,mid+1,rightIndex)
//     }
// }

// const arr = [2, 4, 6, 8, 10, 12, 14, 16]

// console.log(binarySearch(arr, 2))    // 0
// console.log(binarySearch(arr, 6))    // 2
// console.log(binarySearch(arr, 10))   // 4
// console.log(binarySearch(arr, 16))   // 7
...
// function fibonocciPrint(a,b,count,limit){
//     if(count == limit){
//         return
//     }
...
//     let c = a + b
//     console.log(c)
//     return fibonocciPrint(b,c,count+=1,limit)
// }
// fibonocciPrint(0,1,0,5)

// function fibRec(a,b,limit){
//     if(limit == 0){
//         return
//     }
...
//     return take1 < take2 && checkArrAscending(arr.slice(2))
// }

// console.log(checkArrAscending([1,2,3,4,5,7,6,5]))

// function checkDescendingArr(arr){
//     if(arr.length <= 1){
//         return true
//     }
...
//     return take1 > take2 && checkDescendingArr(arr.slice(2))
// }
